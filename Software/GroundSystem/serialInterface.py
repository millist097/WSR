...
class GuiPart:
	...
	def __init__(self, master, queue, ser, endCommand):
		self.queue = queue
		# Set up the GUI
...
class ThreadedClient:
	...
	def __init__(self, master):
		...
		# Set up the GUI part
		self.gui = GuiPart(master, self.queue, self.ser, self.endApplication)
